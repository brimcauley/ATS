...
WebUI.setText(findTestObject('Object Repository/Page_Account Login/input_Login Name_loginname'), 'joeyjordison102')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Account Login/input_Password_password'), 'tGCCc3v96hppwrVZEE0uww==')
